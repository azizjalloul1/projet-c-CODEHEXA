...
bool Examen::ajouterExamen()
{
    ...
    // ajout un examen
    QSqlQuery query;
    query.prepare("INSERT INTO EXAMEN (ID_EXAMEN, MATIERE, NIVEAU, DATE_EXAMEN, HEURE, QUANTITE) "
                  "VALUES (:code, :matiere, :niveau, TO_DATE(:exam_date, 'YYYY-MM-DD'), :heure, :quantite)");
